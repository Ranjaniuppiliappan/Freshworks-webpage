...
function getMovies(srcTxt) {
    axios
        .get(
            "https://api.themoviedb.org/3/search/movie?api_key=cec2a8af688423b2e0c87700e19ce47f&language=en-US&query=" +
                srcTxt +
    ...
    axios
        ...
        <div class="row">
          <div class="well">
            ...
            ${movie.overview}
            <hr>
            <a style="font-weight:bold" href="http://imdb.com/title/${movie.imdb_id}" target="_blank" class="btn btn-primary">View IMDB</a>
            <a class="navbar-brand" href="index.html">Go Back to Search</a>
          </div>
        </div>
        `;
